<?php
    ...
    $IjinAksesSaya=IjinAksesSaya($Conn,$SessionIdAkses,'va9SiDMNXdRPjqLeVcX');
    if($IjinAksesSaya!=="Ada"){
        ...
        if(empty($_GET['id'])){
            ...
            if($kategori_transaksi=="Pembelian"){
                $url_back="index.php?Page=Pembelian&Sub=TambahPembelian&retur=Tidak";
            }else{
                if($kategori_transaksi=="Retur Pembelian"){
                    $url_back="index.php?Page=Pembelian&Sub=TambahPembelian&retur=Ya";
                }else{
                    $url_back="index.php";
                }
            }
